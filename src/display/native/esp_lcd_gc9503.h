 ...
 *
 */
#define GC9503_PANEL_BUS_DSI_2CH_CONFIG()                \
    {                                                    \
        .bus_id = 0,                                     \
        .num_data_lanes = 2,                             \
...
#define GC9503_PANEL_BUS_DSI_1CH_CONFIG()                \
    {                                                    \
        .bus_id = 0,                                     \
        .num_data_lanes = 1,                             \
        .phy_clk_src = MIPI_DSI_PHY_CLK_SRC_DEFAULT,     \
 ...
 *
 */
#define GC9503_PANEL_IO_DBI_CONFIG()  \
    {                                 \
        .virtual_channel = 0,         \
        .lcd_cmd_bits = 8,            \
        .lcd_param_bits = 8,          \
 ...
 *
 */
#define GC9503_376_960_PANEL_60HZ_DPI_CONFIG(px_format) \
    {                                                    \
        .virtual_channel = 0,                            \
