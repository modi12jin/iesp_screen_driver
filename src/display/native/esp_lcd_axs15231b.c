...
static esp_err_t panel_axs15231b_mirror(esp_lcd_panel_t *panel, bool mirror_x, bool mirror_y)
{
    ...
    ESP_RETURN_ON_ERROR(tx_param(axs15231b, io, LCD_CMD_MADCTL, (uint8_t[]){axs15231b->madctl_val}, 1), TAG, "send command failed");
    return ret;
}
...
static esp_err_t panel_axs15231b_swap_xy(esp_lcd_panel_t *panel, bool swap_axes)
{
    ...
    esp_lcd_panel_io_tx_param(io, LCD_CMD_MADCTL, (uint8_t[]){axs15231b->madctl_val}, 1);
    return ESP_OK;
}
