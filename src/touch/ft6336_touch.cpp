...
ft6336_touch::ft6336_touch(int8_t sda_pin, int8_t scl_pin, int8_t rst_pin, int8_t int_pin)
{
    _sda = sda_pin;
    _scl = scl_pin;
    _rst = rst_pin;
...
bool ft6336_touch::getTouch(uint16_t *x, uint16_t *y)
{
...
void ft6336_touch::set_rotation(uint8_t r){
switch(r){
    case 0:
